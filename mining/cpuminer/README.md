...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitcoinsv/bsvd/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/bitcoinsv/bsvd/mining/cpuminer
```
