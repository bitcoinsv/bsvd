...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [bsvwallet](https://github.com/bitcoinsv/bsvwallet).
...
[rpcclient](https://github.com/bitcoinsv/bsvd/rpcclient) package.
...
[rpcclient](https://github.com/bitcoinsv/bsvd/rpcclient) package to connect with
