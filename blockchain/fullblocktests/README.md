...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/bitcoinsv/bsvd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/bitcoinsv/bsvd/blockchain/fullblocktests
```
